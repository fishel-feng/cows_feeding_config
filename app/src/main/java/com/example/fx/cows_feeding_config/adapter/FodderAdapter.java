...
public class FodderAdapter extends RecyclerView.Adapter<FodderAdapter.ViewHolder> implements View.OnClickListener {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            fodderView = itemView;
            tvFodderName = itemView.findViewById(R.id.tv_fodder_name);
            tvFodderType = itemView.findViewById(R.id.tv_fodder_type);
            tvFodderPrice = itemView.findViewById(R.id.tv_fodder_price);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fodder, parent, false);
